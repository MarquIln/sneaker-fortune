...
import { blinkAnimation, lineAnimation, spinAnimation } from "@/helpers/animations";
...
export const ImageColumn = ({ images, animate, animationKey, linesWithMatches, winningLineIndex, columnIndex }: ColumnImage) => {
    ...
    <div className="flex flex-col gap-4">
      {images.map((image, index) => (
        ...
        >
          ...
          {isMainDiagonal && columnIndex === index && renderLine("0%", "0%", "100%", "100%")}
          
          {isAntiDiagonal && columnIndex + index === 2 && renderLine("100%", "0%", "0%", "100%")}
